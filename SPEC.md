...
B7|2026-08-11|`guardrails / check` setting-drift check found fragment-derived `.markdownlint.yml` and `.yamllint.yml` absent; generated settings were ignored and therefore not present in the repository|Materialize and force-track the pinned fragment-derived lint configuration files
